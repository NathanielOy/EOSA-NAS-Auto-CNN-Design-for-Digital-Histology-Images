...
base_dir='/content/gdrive/MyDrive/Paper13/' #'../../' #
base_dir_breakhis='Data/BreakHis/'
base_dir_beach='Data/Bach/'
base_dir_dest='Data/Preprocessed/'
height = 224
width = 224
...
def loadImages_breakhis(path):
    '''Put files into lists and return them as one list with all images 
     in the folder'''
    folders=['fold1/train', 'fold2/train', 'fold3/train', 'fold4/train', 'fold5/train',
...
def processing(data, datype, base_dir_dest):  
    ...
    norm_images = normalize_images(denoised_images)
    img, _=norm_images[1]
