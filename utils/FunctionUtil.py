...
def objective_func(loss_train=None, accuracy_train=None, time_total_train=None):
    idx_loss=len(loss_train)-1
    idx_acc=len(accuracy_train)-1
    return loss_train[idx_loss]+accuracy_train[idx_acc]+time_total_train
